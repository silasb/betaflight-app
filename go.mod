...
replace github.com/fiam/msp-tool v0.0.0-20180218210101-e86acb5a412e => github.com/silasb/msp-tool v0.0.1-break-up-packages
...
require (
	...
	github.com/silasb/msp-tool v0.0.1-break-up-packages
